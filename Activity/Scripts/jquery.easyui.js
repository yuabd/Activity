...
(function ($) {
    function _4e(_4f) {
        ...
        if (_50.text) {
            ...
            if (_50.iconCls) {
                $(_4f).find(".l-btn-text").addClass(_50.iconCls).css("padding-left", "5px").css("padding-right", "5px");
            }
        } else {
...
(function ($) {
    ...
    function _205(_206, _207, _208, _isModal, _isAutoClose) {
        _isModal = (_isModal==null|| _isModal==undefined) ? true : _isModal;
        _isAutoClose =  (_isAutoClose==null|| _isAutoClose==undefined) ? true : _isAutoClose;
        ...
        win.window({ title: _206, noheader: (_206 ? false : true), width: 350, height: "auto", modal: _isModal, collapsible: false, minimizable: false, maximizable: false, resizable: false, onClose: function () {
            setTimeout(function () {
                win.window("destroy");
            }, 100);
        } 
    ...
    $.messager = { show: function (_20a) {
        ...
        win.window("open");
    }, alert: function (_20b, msg, icon, fn, _isModal, _isAutoClose) {
        ...
        var win = _205(_20b, _20c, _20d, _isModal, _isAutoClose);
...
(function ($) {
    ...
    }, length: { validator: function (_364, _365) {
